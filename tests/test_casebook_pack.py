"""Regression checks for the harbor-tool-diff-mark casebook."""
...
from casebook.harness import assert_expected, harbor_tool_diff_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_tool_diff_mark_summary(), assert_expected())
